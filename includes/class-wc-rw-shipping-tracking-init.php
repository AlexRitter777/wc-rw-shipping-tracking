            ...
            if (!empty($tracking_number = $order->get_meta('tracking_number'))){
                        ...
                        <div class="wc-rw-customer-view-container">
                            <div class="wc-rw-customer-view-left">
                                <strong>Shipped by '. $shipping_company .' : </strong>    
                                <a href="' . $shipping_url . $tracking_number . '" target="_blank">' . $tracking_number . '</a>
                                <p class = "shipping-date">Shipped on: '.$shipping_date .'</p>
                                 
                            </div>
                            <div class="wc-rw-customer-view-right">
                               <a class="button" href="' . $shipping_url . $tracking_number . '" target="_blank">Track</a>    
                            </div>
                ...
                <table style="width:100%;margin:10px 0;border:1px solid #e0e0e0;border-radius:3px;background:#fafafa;border-spacing:0" width="100%" bgcolor="#fafafa" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="3" style="padding:10px;padding-bottom:0">
                            <h2 style="font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;text-align:left;display:inline-block;color:#333;vertical-align:middle;font-weight:500;line-height:80%;font-size:18px;margin:0 0 10px">Shipment tracking</h2>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" style="padding:10px;padding-top:0; padding-bottom:0">
                            <span style="margin-top:5px;display:inline-block;font-size:14px">Shipped on: <b> ' . $shipping_date . '</b></span>					
                        </td>
                    </tr>
                    ...
                    <tr>  
                        ...
                        <td style="padding:10px; padding-top:0; padding-bottom:0">
                            <span style="word-break:break-word;margin-right:5px;font-size:14px;display:block">Shipping company: <b>' . $shipping_company . '</b></span>
                            <span style="word-break:break-word;margin-right:5px;font-size:14px;display:block">Tracking number: <a href="' . $shipping_url . $tracking_number . '" style="font-weight:normal;color:#03a9f4;text-decoration:none;font-size:14px;" target="_blank" >' . $tracking_number . '</a></span>	
                        </td>
                        
                        <td  style="text-align:right;padding:15px" align="right"> <!--class="m_2689815068876813734fluid_2cl_td_button"-->
                            <a href="' . $shipping_url . $tracking_number . '"  style="font-weight:normal;background:#005b9a;padding:7px 15px;text-decoration:none;display:inline-block;border-radius:3px;margin-top:2px;text-align:center;min-height:8px;white-space:nowrap;color:#fff;font-size:14px" bgcolor="#005b9a" target="_blank" >Track</a>	
                        </td>                   
